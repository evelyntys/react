...
export default class App extends React.Component{
  ...
  //not triggered by event handler so don't need to be arrow function
  //when switch tabs, the inactive component will be unmounted
  renderContent(){
    if (this.state.active === 'listing'){
      //create and render an instance of the Listing component
      return (<Listing/>)
    }
